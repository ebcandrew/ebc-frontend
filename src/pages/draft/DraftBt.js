...
function DraftBt() {
  ...
  const renderRows = () => {
    const firstRow = (
      <div className="spicie__rows banned" key={0}>
        <div className="spicie__select-contianer">
          <h1>Banned</h1>
  ...
  return (
    <div className="draftbt league">
      <div className="league__banner">
        <div className="league__banner__1">
          <h3>
            Draft League - <span>build team</span>
          </h3>
      ...
      <div className="draftbt__body">
        <div className="draftbt__body__heading">
        ...
        <div className="draftbt__body__item">
        ...
        <div className="draftbt__body__item ">
          ...
          <div className="other__items">
            ...
            <div className="other__items__rule">
              ...
              <div className="DraftButtonWrapper">
