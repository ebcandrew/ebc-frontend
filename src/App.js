  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/addblog" element={admin && <AddBlog />} />
        <Route path="/editblog/:id" element={admin && <EditBlog />} />
        <Route path="/editproducts/:id" element={admin && <EditProducts />} />
        <Route
          path="/edit-tournament/:id"
          element={admin && <EditTournament />}
        />
        ...
        <Route path="/adminboard" element={admin && <AdminDashboard />} />
